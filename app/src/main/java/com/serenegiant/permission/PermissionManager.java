...
//    public static void simCallPermission(Activity activity, PermissionCallBack permissionCallBack) {
//        requestPermission(activity, permissionCallBack, PermissionRequest.REQUEST_CODE_SIM_CALL);
//    }
